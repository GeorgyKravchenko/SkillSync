...
const BaseReactionButtonGroup = () => {
  const [reaction, setReaction] = useState<'like' | 'dislike' | null>(null);
  const toggleReaction = (newReaction: 'like' | 'dislike') => {
    ...
    <div className="flex items-center gap-2">
      ...
      <label className="cursor-pointer group p-1">
        <input
          ...
          onChange={() => toggleReaction('dislike')}
          className="sr-only"
...
export default BaseReactionButtonGroup;
